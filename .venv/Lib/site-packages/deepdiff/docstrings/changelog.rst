...
- v9-1-0
   ...
   - Added wildcard/glob pattern support for ``exclude_paths`` and ``include_paths`` thanks to `akshat62 <https://github.com/akshat62>`__
   ...
   - Packaging: added missing files to sdist and removed obsolete ``MANIFEST.in`` thanks to `mgorny <https://github.com/mgorny>`__
